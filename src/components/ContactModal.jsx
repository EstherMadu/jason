...
const ContactModal = ({ isOpen, onClose }) => {
  ...
  return (
    <Modal onClose={onClose} isOpen={isOpen} isCentered size="lg">
      <ModalOverlay />
      <ModalContent
        bg={useColorModeValue("white", "rgb(36 41 47)")}
        rounded="xl"
        p="0"
      >
        <ModalBody py="12" px={{ base: 8, md: 12 }}>
          ...
          <SimpleGrid columns={{ base: 3, md: 3 }} spacing={{ base: 3, md: 4 }}>
            <Flex
              onClick={() =>
                handleClick("Email", "mailto:jaysinscars@gmail.com")
              }
              direction="column"
              align="center"
              border="1px solid"
            ...
            <Flex
              onClick={() =>
                handleClick("Github", "https://github.com/Jaysins/")
              }
              direction="column"
              align="center"
              border="1px solid"
            ...
            <Flex
              onClick={() =>
                handleClick("Codepen", "https://codepen.io/jaysins")
              }
              direction="column"
              align="center"
              border="1px solid"
            ...
            <Flex
              onClick={() =>
                handleClick("Telegram", "https://t.me/jaysinscars")
              }
              direction="column"
              align="center"
              border="1px solid"
            ...
            <Flex
              onClick={() =>
                handleClick("Linkedin", "https://www.linkedin.com/in/jaysins/")
              }
              direction="column"
              align="center"
              border="1px solid"
            ...
            <Flex
              onClick={() =>
                handleClick("Twitter", "https://twitter.com/jaysinscars")
              }
              direction="column"
              align="center"
              border="1px solid"
